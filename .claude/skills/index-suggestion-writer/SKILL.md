---
name: "index-suggestion-writer"
pack: "backend-persistence-pack"
purpose: "Suggest indexes, access paths, uniqueness rules, and supporting constraints based on query patterns and data lifecycle."
...
handoffs: ["schema-normalizer", "data-migration-planner", "query-complexity-reviewer"]
---
# index-suggestion-writer

## Purpose
Suggest indexes, access paths, uniqueness rules, and supporting constraints based on query patterns and data lifecycle.
