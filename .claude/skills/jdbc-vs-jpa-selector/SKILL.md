---
name: "jdbc-vs-jpa-selector"
pack: "backend-persistence-pack"
purpose: "Select between lower-level SQL access and ORM approaches based on control, complexity, performance, portability, and team capability."
...
handoffs: ["orm-mapping-reviewer", "dao-pattern-builder", "query-complexity-reviewer"]
---
# jdbc-vs-jpa-selector

## Purpose
Select between lower-level SQL access and ORM approaches based on control, complexity, performance, portability, and team capability.
