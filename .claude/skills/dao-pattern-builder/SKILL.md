---
name: "dao-pattern-builder"
pack: "backend-persistence-pack"
purpose: "Define DAO-style access objects, responsibilities, interfaces, and query ownership for systems using explicit data access layers."
...
handoffs: ["repository-layer-designer", "jdbc-vs-jpa-selector", "query-complexity-reviewer"]
---
# dao-pattern-builder
