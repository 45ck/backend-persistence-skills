---
name: "api-error-model-designer"
pack: "backend-persistence-pack"
purpose: "Design a consistent backend error model including codes, categories, validation failures, conflict cases, and recovery semantics."
...
handoffs: ["api-contract-writer", "crud-surface-reviewer", "transaction-boundary-checker"]
---
# api-error-model-designer

## Purpose
Design a consistent backend error model including codes, categories, validation failures, conflict cases, and recovery semantics.
