...
purpose: "Review a relational schema for redundancy, dependency issues, naming consistency, key design, and normalization tradeoffs."
...
handoffs: ["index-suggestion-writer", "data-migration-planner", "repository-layer-designer"]
---
# schema-normalizer

## Purpose
Review a relational schema for redundancy, dependency issues, naming consistency, key design, and normalization tradeoffs.
