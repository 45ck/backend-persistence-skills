...
purpose: "Review transaction scope, consistency boundaries, concurrency assumptions, rollback behavior, and side-effect ordering."
...
handoffs: ["persistence-test-planner", "api-contract-writer", "data-migration-planner"]
---
# transaction-boundary-checker

## Purpose
Review transaction scope, consistency boundaries, concurrency assumptions, rollback behavior, and side-effect ordering.
