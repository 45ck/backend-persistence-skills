---
name: "entity-model-designer"
pack: "backend-persistence-pack"
purpose: "Design core backend entities, aggregates, identifiers, relationships, and lifecycle rules so domain data is represented coherently."
...
handoffs: ["schema-normalizer", "orm-mapping-reviewer", "api-contract-writer"]
---
# entity-model-designer

## Purpose
Design core backend entities, aggregates, identifiers, relationships, and lifecycle rules so domain data is represented coherently.
