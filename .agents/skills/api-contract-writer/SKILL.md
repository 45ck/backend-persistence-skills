...
purpose: "Write backend API contracts covering endpoints or operations, payloads, validation, errors, idempotency, and state transitions."
...
handoffs: ["api-error-model-designer", "crud-surface-reviewer", "persistence-test-planner"]
---
# api-contract-writer

## Purpose
Write backend API contracts covering endpoints or operations, payloads, validation, errors, idempotency, and state transitions.
