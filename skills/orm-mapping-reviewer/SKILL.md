---
name: "orm-mapping-reviewer"
pack: "backend-persistence-pack"
purpose: "Review ORM entity mappings, relations, cascades, lazy/eager loading, and persistence assumptions for correctness and maintainability."
...
handoffs: ["transaction-boundary-checker", "query-complexity-reviewer", "persistence-test-planner"]
---
# orm-mapping-reviewer

## Purpose
Review ORM entity mappings, relations, cascades, lazy/eager loading, and persistence assumptions for correctness and maintainability.
