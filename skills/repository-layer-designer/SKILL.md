---
name: "repository-layer-designer"
pack: "backend-persistence-pack"
purpose: "Design repository, DAO, or data access boundaries so persistence logic is centralized, testable, and separated from business rules."
...
handoffs: ["dao-pattern-builder", "transaction-boundary-checker", "persistence-test-planner"]
---
# repository-layer-designer

## Purpose
Design repository, DAO, or data access boundaries so persistence logic is centralized, testable, and separated from business rules.
