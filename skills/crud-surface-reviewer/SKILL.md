---
name: "crud-surface-reviewer"
pack: "backend-persistence-pack"
purpose: "Review whether the system exposes the right create, read, update, and delete operations without overexposing internals or missing key workflows."
...
handoffs: ["api-contract-writer", "repository-layer-designer", "transaction-boundary-checker"]
---
# crud-surface-reviewer

## Purpose
Review whether the system exposes the right create, read, update, and delete operations without overexposing internals or missing key workflows.
